...
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:UpyAK7ROHv6CDDv8uGvF5A==$Y9/upo+k0iaWuJj56u3D6OVQabeDlnB2g66pbS4l+yk=:qgjnqYuckx74Q/YJ4Mr2E0nccs0mOUXLkKIcetADx8U=';
...
--
-- Name: chms_db; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE chms_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE chms_db OWNER TO postgres;
